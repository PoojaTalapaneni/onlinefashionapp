...
class OrderServiceImplTest {
	...
	void testGetAllOrders() throws Exception {
		Order order1=new Order("A","15/11/2022", 1, "status");
		Order order2=new Order("B","16/11/2022", 2, "status");
	...
	void testGetOrderByOrderDate() throws Exception{
			Order sampleOutput = new Order("A","12/02/2022",200,"Yes");
			//given
	...
	void testGetOrderByTotalOrderCost()throws Exception {
		Order sampleOutput = new Order("A","Date",1,"status");
		//given
